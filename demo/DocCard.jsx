...
export default class DocCard extends PureComponent {
    static propTypes = {
            ...
            cardData ?
                <div className="base-card">
                    ...
                    <div className="base-card-right">
                        { cardData.name ? <div className="base-card-name">{cardData.name}<span className="base-card-author">作者:{cardData.author}</span></div> : null }
